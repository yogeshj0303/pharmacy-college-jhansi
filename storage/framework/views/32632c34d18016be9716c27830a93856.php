...
<div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
    <div class="carousel-inner">
        <?php $__currentLoopData = $BannerImage; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="carousel-item <?php echo e($loop->first ? 'active' : ''); ?>">
                <img src="<?php echo e(asset($image->image)); ?>" class="d-block w-100" alt="Banner Image">
            </div>
...
?>
<?php if($newsEvents->count() > 0): ?>
            <div class="news-container">
<div class="news-events">
  <div class="headernew">NEWS & EVENTS 2025</div>
  <div class="scroll-container">
  <ul>
                <?php $__currentLoopData = $newsEvents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $news): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <li><?php echo e($news->title); ?> : 
                        <a href="<?php echo e(asset(''.$news->upload_pdf)); ?>" target="_blank">Click on link</a>
                    </li>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </ul>
  </div>
...
<div class="news-events">
  ...
  <ul>
            <?php $__currentLoopData = $notices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <li><?php echo e($notice->title); ?> : 
                    <a href="<?php echo e(asset(''.$notice->upload_pdf)); ?>" target="_blank">Click on link</a>
                </li>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </ul>
  </div>
...
<?php endif; ?>
<?php /**PATH C:\Users\DELL\OneDrive\Desktop\xampp1\PharmacyCollege\resources\views/frontend/index.blade.php ENDPATH**/ ?>