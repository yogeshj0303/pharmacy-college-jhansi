...
<?php $__env->startSection('title', 'Naac Report'); ?>
...
<?php $__env->slot('li_1'); ?> NAAC  <?php $__env->endSlot(); ?>
<?php $__env->slot('title'); ?> NAAC Reports <?php $__env->endSlot(); ?>
...
<div class="row">
    <div class="col-md-7">
        ...
        <div class="card">
                ...
                <div style="overflow-x: auto;">
                    <table id="documentTable" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            <?php $__currentLoopData = $naacReports; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $report): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                            <td><?php echo e($naacReports->firstItem() + $index); ?></td>
                            <td><?php echo e($report->category->category_name ?? 'N/A'); ?></td> <!-- Assuming category has a title field -->
                                <td><?php echo e($report->title); ?></td>
                                <td>
                                    <a href="<?php echo e(asset(''.$report->document)); ?>" target="_blank" rel="noopener noreferrer">
                                        View Document
                                    </a>
                                </td>
                                <td>
                                    <button class="btn btn-primary btn-sm editReport" data-id="<?php echo e($report->id); ?>" data-title="<?php echo e($report->title); ?>"  data-category-id="<?php echo e($report->category->id); ?>"  data-document="<?php echo e(asset($report->document)); ?>">Edit</button>
            ...
            <?php echo e($naacReports->links('pagination::bootstrap-4')); ?>
    ...
    <div class="col-md-5">
        ...
        <div class="card">
            ...
            <div class="card-body">
            <form id="naacReportForm" method="POST" action="<?php echo e(route('naac-reports.store')); ?>" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
    <div class="mb-3">
...
$('#editDocumentForm').on('submit', function (e) {
    ...
    $.ajax({
        url: '<?php echo e(route('naac-reports.update', '')); ?>/' + $('#documentId').val(),
        type: 'POST',
        data: formData,
        processData: false,
        contentType: false,
        ...
        $(document).on('click', '.deleteReport', function () {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: '<?php echo e(route('naac-reports.destroy', '')); ?>/' + id,
                        type: 'DELETE',
                        data: {
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\DELL\OneDrive\Desktop\xampp1\PharmacyCollege\resources\views/Naac/naac_report.blade.php ENDPATH**/ ?>