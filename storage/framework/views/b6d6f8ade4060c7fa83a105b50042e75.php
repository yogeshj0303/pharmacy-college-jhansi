...
<div class="row">
    ...
    <i class="fas fa-eye" data-bs-toggle="modal" data-bs-target="#descriptionModal" data-description="<?php echo e($course->description); ?>" style="background-color:rgb(6, 83, 28); padding: 5px; color:white"></i>
                            ...
                            <td>
                                ...
                                <button class="btn btn-danger btn-sm deleteImage mt-2" data-id="<?php echo e($course->id); ?>">Delete</button>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\DELL\OneDrive\Desktop\xampp1\PharmacyCollege\resources\views/Academic/Course/create.blade.php ENDPATH**/ ?>