...
<a href="#" class="dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
    ...
    <i class="bi bi-caret-down-fill"></i> <!-- Bootstrap dropdown icon -->
        ...
        <div class="dropdown-menu">
            <?php $__currentLoopData = $naacCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <a href="<?php echo e(route('naachome', $category->id)); ?>"><?php echo e($category->category_name); ?></a>
    ...
    <div style="display: flex; gap: 15px; width: 100%;">
        ...
        <div style="flex: 1;  width: 100%;">
            <select id="course" name="course" style="width: 100%;">
                ...
                <?php $__currentLoopData = $course; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $coursename): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($coursename->course_name); ?>"><?php echo e($coursename->course_name); ?></option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </select>
   ...
   <script>
    $(document).ready(function () {
        ...
        function loadDistricts(selectedDistrict = null) {
            var state = $('#state').val();
            if (state) {
                var statesData = <?php echo json_encode($statesData['states'], 15, 512) ?>; // Blade directive to pass data
        ...
        var oldState = <?php echo json_encode(old('state'), 15, 512) ?>;
        var oldDistrict = <?php echo json_encode(old('district'), 15, 512) ?>;
...
$(document).ready(function () {
    $("#enquiryForm").submit(function (e) {
        ...
        $.ajax({
            url: "<?php echo e(route('submit.form')); ?>",
            method: "POST",
            data: $(this).serialize(),
            dataType: "json",
...
<?php /**PATH C:\Users\DELL\OneDrive\Desktop\xampp1\PharmacyCollege\resources\views/components/front-header.blade.php ENDPATH**/ ?>