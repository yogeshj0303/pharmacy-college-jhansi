...
<?php $__env->slot('li_1'); ?> Admission <?php $__env->endSlot(); ?>
<?php $__env->slot('title'); ?> Admission Data <?php $__env->endSlot(); ?>
...
<div class="row">
                ...
                <table id="documentTable" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        <td><?php echo e($documents->firstItem() + $index); ?></td>
                            ...
                            <td>
                                <a href="<?php echo e(asset(''.$document->document)); ?>" target="_blank" rel="noopener noreferrer">
                                    View Document
                                </a>
                            </td>
                            <td>
                                <button class="btn btn-primary btn-sm editDocument" data-id="<?php echo e($document->id); ?>" data-title="<?php echo e($document->title); ?>" data-document="<?php echo e(asset($document->document)); ?>">Edit</button>
    ...
    <div class="col-md-5">
        ...
        <div class="card">
            <div class="card-header">
                <h5 class="card-title">Add New Admission</h5>
            </div>
            <div class="card-body">
            <form id="documentForm" method="POST" action="<?php echo e(route('admission.store')); ?>" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="editDocumentModalLabel">Edit Admission</h5>
            ...
            <div class="modal-body">
                <form id="editDocumentForm">
                    ...
                    <div class="mb-3">
                        <label for="editDocument" class="form-label">Admission document</label>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#editDocumentForm').on('submit', function (e) {
            ...
            $.ajax({
                url: '<?php echo e(route('admission.update', '')); ?>/' + $('#documentId').val(),
                type: 'POST',
                data: formData,
                processData: false,
                contentType: false,
        ...
        $(document).on('click', '.deleteDocument', function () {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: '<?php echo e(route('admission.destroy', '')); ?>/' + id,
                        type: 'DELETE',
                        data: {
    ...
    Swal.fire({
        icon: 'success',
        title: 'Admission pdf has been delete!',
       
        confirmButtonColor: '#3085d6',
        confirmButtonText: 'OK'
    }).then((result) => {
        if (result.isConfirmed) {
            location.reload(); // Reload the page after the SweetAlert is confirmed
        }
    });
}
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\DELL\OneDrive\Desktop\xampp1\PharmacyCollege\resources\views/Enquiry/admission.blade.php ENDPATH**/ ?>