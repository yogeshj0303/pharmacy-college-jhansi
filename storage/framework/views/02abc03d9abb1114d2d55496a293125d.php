    ...
    <?php $__currentLoopData = $documents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $document): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="col-md-6">
            <div class="committee-card">
                <div>
                    <h5><?php echo e($document->title); ?></h5>
                    <p>
                        <a href="<?php echo e(asset($document->document)); ?>" target="_blank">
                            Click to view <?php echo e($document->title); ?>

                        </a>
                    </p>
                </div>
                <a href="<?php echo e(asset($document->document)); ?>" download>
...
<?php endif; ?>
<?php /**PATH C:\Users\DELL\OneDrive\Desktop\xampp1\PharmacyCollege\resources\views/frontend/discipline.blade.php ENDPATH**/ ?>