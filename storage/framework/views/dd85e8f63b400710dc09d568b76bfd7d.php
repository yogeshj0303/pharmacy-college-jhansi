            ...
            <div class="d-flex align-items-center">
                ...
                <div class="dropdown ms-sm-3 header-item topbar-user ">
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <a class="dropdown-item" href="<?php echo e(route('changepassworduser')); ?>">
...
<form id="logout-form" action="<?php echo e(route('newlogout')); ?>" method="POST" style="display: none;">
    <?php echo csrf_field(); ?>
</form>
...
<?php /**PATH C:\Users\DELL\OneDrive\Desktop\xampp1\PharmacyCollege\resources\views/layouts/topbar.blade.php ENDPATH**/ ?>