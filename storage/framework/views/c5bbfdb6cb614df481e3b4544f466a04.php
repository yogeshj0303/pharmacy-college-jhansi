...
<?php $__env->slot('li_1'); ?> Newsletter <?php $__env->endSlot(); ?>
<?php $__env->slot('title'); ?> Newsletter Data <?php $__env->endSlot(); ?>
...
<div class="row">
    ...
    <div class="d-flex gap-2">
        <button class="btn btn-primary btn-sm editDocument" 
            data-id="<?php echo e($document->id); ?>" 
            data-title="<?php echo e($document->title); ?>" 
            data-document="<?php echo e(asset($document->document)); ?>">
            Edit
        </button>
        <button class="btn btn-danger btn-sm deleteDocument" 
            data-id="<?php echo e($document->id); ?>">
            Delete
        </button>
    </div>
    ...
    <div class="col-md-5">
        ...
        <div class="card">
            <div class="card-header">
                <h5 class="card-title">Add New Newsletter</h5>
            </div>
            <div class="card-body">
                <form id="documentForm" method="POST" action="<?php echo e(route('media-documents.store')); ?>" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <div class="mb-3">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="editDocumentModalLabel">Edit Newsletter</h5>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#editDocumentForm').on('submit', function (e) {
            ...
            $.ajax({
                url: '<?php echo e(route('media-documents.update', '')); ?>/' + $('#documentId').val(),
                type: 'POST',
                data: formData,
                processData: false,
                contentType: false,
        ...
        $(document).on('click', '.deleteDocument', function () {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: '<?php echo e(route('media-documents.destroy', '')); ?>/' + id,
                        type: 'DELETE',
                        data: {
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\DELL\OneDrive\Desktop\xampp1\PharmacyCollege\resources\views/media/newsletter.blade.php ENDPATH**/ ?>