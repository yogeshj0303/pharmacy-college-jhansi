...
<?php $__env->startSection('title', 'Placed student'); ?>
...
<?php $__env->slot('li_1'); ?> Placed Student <?php $__env->endSlot(); ?>
<?php $__env->slot('title'); ?> Placed Student Data <?php $__env->endSlot(); ?>
...
<div class="row">
    <div class="col-md-7">
        ...
        <div class="card">
            <div class="card-header">
                <h5 class="card-title"> Placed Student Images</h5>
            </div>
            <div class="card-body">
    ...
    <div class="col-md-5">
        ...
        <div class="card">
            <div class="card-header">
                <h5 class="card-title">Add New  Placed Student Image</h5>
            </div>
            <div class="card-body">
            <form id="imageForm" method="POST" action="<?php echo e(route('placedstudent.store')); ?>" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="editImageModalLabel">Edit Placed Student Image</h5>
...
<script>
    $(document).ready(function () {
        ...
        $(document).on('click', '.editImage', function () {
            var id = $(this).data('id');
            var year = $(this).data('year'); // Ensure you're passing year in the button's data attributes
        ...
        $('#editImageForm').on('submit', function (e) {
            ...
            $.ajax({
                url: '<?php echo e(route('placedstudent.update', '')); ?>/' + $('#imageId').val(),
                type: 'POST',
                data: formData,
                processData: false,
                contentType: false,
        ...
        $(document).on('click', '.deleteImage', function () {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: '<?php echo e(route('placedstudent.destroy', '')); ?>/' + id,
                        type: 'DELETE',
                        data: {
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\DELL\OneDrive\Desktop\xampp1\PharmacyCollege\resources\views/Training/placestudent.blade.php ENDPATH**/ ?>