...
<?php $__env->slot('li_1'); ?> image <?php $__env->endSlot(); ?>
<?php $__env->slot('title'); ?> image Data <?php $__env->endSlot(); ?>
...
<div class="row">
    ...
    <img src="<?php echo e(asset(''.$image->image)); ?>" alt="Image" style="width: 80px; height: 80px;">
</a>
    ...
    <div class="col-md-5">
        ...
        <div class="card">
            ...
            <div class="card-body">
            <form id="imageForm" method="POST" action="<?php echo e(route('bannerimage.store')); ?>" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="mb-3">
        ...
        <img id="imagePreview" src="" alt="Image Preview" style="width: 200px; display: none;">
    </div>
...
<script>
    $(document).ready(function () {
        ...
        $('#editImageForm').on('submit', function (e) {
            ...
            $.ajax({
                url: '<?php echo e(route('bannerimage.update', '')); ?>/' + $('#imageId').val(),
                type: 'POST',
                data: formData,
                processData: false,
                contentType: false,
        ...
        $(document).on('click', '.deleteImage', function () {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: '<?php echo e(route('bannerimage.destroy', '')); ?>/' + id,
                        type: 'DELETE',
                        data: {
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\DELL\OneDrive\Desktop\xampp1\PharmacyCollege\resources\views/Banner/create.blade.php ENDPATH**/ ?>