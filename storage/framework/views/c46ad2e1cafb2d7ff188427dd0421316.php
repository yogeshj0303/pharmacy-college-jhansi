...
<?php $__env->startSection('title', 'Media Images'); ?>
...
<div class="row">
    ...
    <img src="<?php echo e(asset(''.$image->image)); ?>" alt="Image" style="width: 100px; height: 100px;">
</a>
    ...
    <div class="col-md-5">
        ...
        <div class="card">
            ...
            <div class="card-body">
            <form id="imageForm" method="POST" action="<?php echo e(route('mediaimage.store')); ?>" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
    <div class="mb-3">
...
<script>
    $(document).ready(function () {
        ...
        $('#editImageForm').on('submit', function (e) {
            ...
            $.ajax({
                url: '<?php echo e(route('mediaimage.update', '')); ?>/' + $('#imageId').val(),
                type: 'POST',
                data: formData,
                processData: false,
                contentType: false,
        ...
        $(document).on('click', '.deleteImage', function () {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: '<?php echo e(route('mediaimage.destroy', '')); ?>/' + id,
                        type: 'DELETE',
                        data: {
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\DELL\OneDrive\Desktop\xampp1\PharmacyCollege\resources\views/media/image.blade.php ENDPATH**/ ?>