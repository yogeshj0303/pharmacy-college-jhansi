...
<?php $__env->slot('li_1'); ?> Discipline <?php $__env->endSlot(); ?>
<?php $__env->slot('title'); ?> Discipline Data <?php $__env->endSlot(); ?>
...
<div class="row">
    ...
    <div class="col-md-5">
        ...
        <div class="card">
            <div class="card-header">
                <h5 class="card-title">Add New Discipline</h5>
            </div>
            <div class="card-body">
            <form id="documentForm" method="POST" action="<?php echo e(route('discipline.store')); ?>" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
    <div class="mb-3">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="editDocumentModalLabel">Edit Discipline</h5>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#editDocumentForm').on('submit', function (e) {
            ...
            $.ajax({
                url: '<?php echo e(route('discipline.update', '')); ?>/' + $('#documentId').val(),
                type: 'POST',
                data: formData,
                processData: false,
                contentType: false,
        ...
        $(document).on('click', '.deleteDocument', function () {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: '<?php echo e(route('discipline.destroy', '')); ?>/' + id,
                        type: 'DELETE',
                        data: {
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\DELL\OneDrive\Desktop\xampp1\PharmacyCollege\resources\views/Academic/faculty/discipline.blade.php ENDPATH**/ ?>