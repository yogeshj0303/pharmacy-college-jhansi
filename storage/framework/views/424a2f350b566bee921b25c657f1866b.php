...
<body>
    ...
    <div class="content-wrapper">
        ...
        <aside class="sidebar-menu">
            <ul id="menu">
            <?php $__currentLoopData = $ActivityCategory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <li class="menu-option" onclick="fetchActivities(<?php echo e($category->id); ?>)">
...
<script>
    function fetchActivities(categoryId) {
        $.ajax({
            url: "<?php echo e(url('get-activities')); ?>/" + categoryId,
            type: "GET",
    ...
    $(document).ready(function () {
        <?php if($firstCategory): ?>
            fetchActivities(<?php echo e($firstCategory->id); ?>);
        <?php endif; ?>
    });
</script>
<script>
...
<?php endif; ?>
<?php /**PATH C:\Users\DELL\OneDrive\Desktop\xampp1\PharmacyCollege\resources\views/frontend/Activities.blade.php ENDPATH**/ ?>