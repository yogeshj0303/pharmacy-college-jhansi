...
<?php $__env->startSection('title', 'Training & placement document'); ?>
...
<?php $__env->slot('li_1'); ?> Training & placement <?php $__env->endSlot(); ?>
<?php $__env->slot('title'); ?> Training & placement document <?php $__env->endSlot(); ?>
...
<div class="row">
    ...
    <div class="col-md-5">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form id="documentForm" method="POST" action="<?php echo e(route('trainingdocument.store')); ?>" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <div class="mb-3">
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#editDocumentForm').on('submit', function (e) {
            ...
            $.ajax({
                url: '<?php echo e(route('trainingdocument.update', '')); ?>/' + $('#documentId').val(),
                type: 'POST',
                data: formData,
                processData: false,
                contentType: false,
        ...
        $(document).on('click', '.deleteDocument', function () {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: '<?php echo e(route('trainingdocument.destroy', '')); ?>/' + id,
                        type: 'DELETE',
                        data: {
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\DELL\OneDrive\Desktop\xampp1\PharmacyCollege\resources\views/Training/training_pdf.blade.php ENDPATH**/ ?>