...
class PlacedStudentController extends Controller
{
    ...
    {
        $images = PlacedStudent::orderBy('id' , 'desc' )->paginate(10); // Fetch all videos from the database
        return view('Training.placestudent' , compact('images'));    }
        ...
        public function update(Request $request, $id)
        {
            ...
            $image = PlacedStudent::findOrFail($id);
