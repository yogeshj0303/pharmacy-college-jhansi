...
class DisciplineController extends Controller
{
    ...
    public function discipline(){
        $documents = Discipline::all();
        return view('frontend.discipline' , compact('documents'));
    }
    
    
    public function create()
    {
        $documents = Discipline::paginate(10); 
        return view('Academic.faculty.discipline', compact('documents'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $mediaDocument = Discipline::create([
            'owner_id' => Auth::id(),
            'title' => $request->title,
    ...
    {
        $document = Discipline::findOrFail($id);
    ...
    public function update(Request $request, $id)
    {
        ...
        $mediaDocument = Discipline::findOrFail($id);
