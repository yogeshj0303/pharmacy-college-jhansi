...
<section class="admissin-container">
    <div class="admissin-left">
        ...
        @foreach($AdmissionPdf as $pdf)
        <div class="admissin-box">

            <div>
                <h2 class="admissin-box-title">Download</h2>
                <p class="admissin-box-text">Click to download the {{ $pdf->title }}</p>
            </div>
            <a href="{{ asset('' . $pdf->document) }}"  class="admission-link" style="text-decoration:none"  target="_blank">
