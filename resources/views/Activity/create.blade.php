...
@slot('title') Activity Data @endslot
@endcomponent
...
<div class="row">
    <div class="col-md-7">
        ...
        <div class="card">
            ...
            <div style="overflow-x: auto;">
                ...
                <table id="documentTable" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                        <td>{{ $ActivityCategories->firstItem() + $index }}</td>
            ...
            {{ $ActivityCategories->links('pagination::bootstrap-4') }}
        </div>
                </div>
            </div>
        </div>
    ...
    <div class="col-md-5">
        <div class="card">
            ...
            <div class="card-body">
                <form id="documentForm" method="POST" action="{{ route('Activity-category.store') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
...
<script>
    $(document).ready(function () {
        ...
        $('#editDocumentForm').on('submit', function (e) {
            ...
            $.ajax({
                url: '{{ route('Activity-category.update', '') }}/' + $('#documentId').val(),
                type: 'POST',
                data: formData,
                processData: false,
                contentType: false,
        ...
        $(document).on('click', '.deleteDocument', function () {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: '{{ route('Activity-category.destroy', '') }}/' + id,
                        type: 'DELETE',
                        data: {
