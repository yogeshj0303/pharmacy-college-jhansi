...
@slot('title') Newsletter Data @endslot
@endcomponent
...
<div class="row">
    ...
    <div class="d-flex gap-2">
        <button class="btn btn-primary btn-sm editDocument" 
            ...
            data-document="{{ asset($document->document) }}">
            Edit
        </button>
    ...
    <div class="col-md-5">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form id="documentForm" method="POST" action="{{ route('media-documents.store') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#editDocumentForm').on('submit', function (e) {
            ...
            $.ajax({
                url: '{{ route('media-documents.update', '') }}/' + $('#documentId').val(),
                type: 'POST',
                data: formData,
                processData: false,
                contentType: false,
        ...
        $(document).on('click', '.deleteDocument', function () {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: '{{ route('media-documents.destroy', '') }}/' + id,
                        type: 'DELETE',
                        data: {
