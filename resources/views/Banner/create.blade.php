...
<div class="row">
    ...
    <img src="{{ asset(''.$image->image) }}" alt="Image" style="width: 80px; height: 80px;">
</a>
    ...
    <div class="col-md-5">
        ...
        <div class="card">
            ...
            <div class="card-body">
            <form id="imageForm" method="POST" action="{{ route('bannerimage.store') }}" enctype="multipart/form-data">
    @csrf
...
<script>
    $(document).ready(function () {
        ...
        $('#editImageForm').on('submit', function (e) {
            ...
            $.ajax({
                url: '{{ route('bannerimage.update', '') }}/' + $('#imageId').val(),
                type: 'POST',
                data: formData,
                processData: false,
                contentType: false,
        ...
        $(document).on('click', '.deleteImage', function () {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: '{{ route('bannerimage.destroy', '') }}/' + id,
                        type: 'DELETE',
                        data: {
