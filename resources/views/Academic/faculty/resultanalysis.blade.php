...
@slot('li_1') Result Analysis @endslot
@slot('title') Result Analysis Data @endslot
@endcomponent
...
<div class="row">
    ...
    <div class="col-md-5">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form id="documentForm" method="POST" action="{{ route('resultanalysis.store') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#editDocumentForm').on('submit', function (e) {
            ...
            $.ajax({
                url: '{{ route('resultanalysis.update', '') }}/' + $('#documentId').val(),
                type: 'POST',
                data: formData,
                processData: false,
                contentType: false,
        ...
        $(document).on('click', '.deleteDocument', function () {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: '{{ route('resultanalysis.destroy', '') }}/' + id,
                        type: 'DELETE',
                        data: {
