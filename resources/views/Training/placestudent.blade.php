...
@slot('li_1') Placed Student @endslot
@slot('title') Placed Student Data @endslot
@endcomponent
...
<div class="row">
    ...
    <img src="{{ asset(''.$image->image) }}" alt="Image" style="max-width: 100px; max-height: 100px;">
</a>
    ...
    <div class="col-md-5">
        ...
        <div class="card">
            ...
            <div class="card-body">
            <form id="imageForm" method="POST" action="{{ route('placedstudent.store') }}" enctype="multipart/form-data">
    @csrf
...
<script>
    $(document).ready(function () {
        ...
        $('#editImageForm').on('submit', function (e) {
            ...
            $.ajax({
                url: '{{ route('placedstudent.update', '') }}/' + $('#imageId').val(),
                type: 'POST',
                data: formData,
                processData: false,
                contentType: false,
        ...
        $(document).on('click', '.deleteImage', function () {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: '{{ route('placedstudent.destroy', '') }}/' + id,
                        type: 'DELETE',
                        data: {
