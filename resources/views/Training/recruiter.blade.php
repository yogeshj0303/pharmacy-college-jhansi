...
@slot('li_1') Recruiter @endslot
@slot('title') Recruiter Data @endslot
@endcomponent
...
<div class="row">
    ...
    <div class="col-md-5">
        ...
        <div class="card">
            ...
            <div class="card-body">
            <form id="imageForm" method="POST" action="{{ route('recruiter.store') }}" enctype="multipart/form-data">
    @csrf
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="editImageModalLabel">Edit Recruiter</h5>
...
<script>
    $(document).ready(function () {
        ...
        $('#editImageForm').on('submit', function (e) {
            ...
            $.ajax({
                url: '{{ route('recruiter.update', '') }}/' + $('#imageId').val(),
                type: 'POST',
                data: formData,
                processData: false,
                contentType: false,
        ...
        $(document).on('click', '.deleteImage', function () {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: '{{ route('recruiter.destroy', '') }}/' + id,
                        type: 'DELETE',
                        data: {
