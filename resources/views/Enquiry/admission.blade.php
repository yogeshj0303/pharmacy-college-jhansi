...
@slot('li_1') Admission @endslot
@slot('title') Admission Data @endslot
@endcomponent
...
<div class="row">
    ...
    <div class="col-md-5">
        ...
        <div class="card">
            ...
            <div class="card-body">
            <form id="documentForm" method="POST" action="{{ route('admission.store') }}" enctype="multipart/form-data">
    @csrf
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#editDocumentForm').on('submit', function (e) {
            ...
            $.ajax({
                url: '{{ route('admission.update', '') }}/' + $('#documentId').val(),
                type: 'POST',
                data: formData,
                processData: false,
                contentType: false,
        ...
        $(document).on('click', '.deleteDocument', function () {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: '{{ route('admission.destroy', '') }}/' + id,
                        type: 'DELETE',
                        data: {
